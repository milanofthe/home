...
// Used to render Cloudflare country codes (which arrive as alpha-2) on a
// Plotly choropleth map (which expects alpha-3 with locationmode: 'ISO-3').
...
export const COUNTRIES: Record<string, CountryInfo> = {
	...
	HM: { iso3: 'HMD', name: 'Heard & McDonald Islands' },
	...
	SZ: { iso3: 'SWZ', name: 'Eswatini' },
	TC: { iso3: 'TCA', name: 'Turks and Caicos Islands' },
	TD: { iso3: 'TCD', name: 'Chad' },
	TF: { iso3: 'ATF', name: 'French Southern Territories' },
...
export function iso2ToIso3(code: string): string | undefined {
	return COUNTRIES[code.toUpperCase()]?.iso3;
}

export function iso2ToName(code: string): string {
